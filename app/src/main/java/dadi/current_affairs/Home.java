...
public class Home extends Fragment implements View.OnClickListener {
    CardView entertainment, myhindu, Gaming, Music, Politics, Science, Sport, Technology,card_view_general,general;
    View context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       /* card_view  = (CardView) x.findViewById(R.id.card_view);
        ...
        general = (CardView) x.findViewById(R.id.card_view_general);
        Gaming = (CardView) x.findViewById(R.id.card_view_games);
        Music = (CardView) x.findViewById(R.id.card_view_music);
        Politics = (CardView) x.findViewById(R.id.card_view_politc);
        Science = (CardView) x.findViewById(R.id.card_view_nature);
        Sport = (CardView) x.findViewById(R.id.card_view_sports);
        Technology = (CardView) x.findViewById(R.id.card_view_technology);
        myhindu = (CardView) x.findViewById(R.id.card_view_busines);
        entertainment = (CardView) x.findViewById(R.id.card_view_ent);
